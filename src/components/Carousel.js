        ...
        <div className="container">
          ...
          >
            <div className="col-lg-7 col-md-12 col-12">
              <h2 data-aos="fade-up">
                Empowering global connectivity to enhance lives and optimize the
                world's operations
              </h2>
              <blockquote data-aos="fade-up" data-aos-delay="100">
                <p>
                  To revolutionize business efficiency and growth through
                  cutting-edge technology solutions, empowering enterprises
              ...
              <div className="d-flex align-items-center">
                ...
                >
                  {" "}
                  <i className="bi bi-play-circle-fill" style={{ color: "#002180" }}></i>
